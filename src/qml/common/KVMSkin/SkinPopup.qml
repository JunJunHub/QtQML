...
Popup {
  ...
  background: Rectangle {
      ...
      Row {
          ...
          BaseSlider {
              ...
              from: 0.5
              to: 1.0
              value:  g_kvmAppSetting.skinOpacity
              onMoved: {
                g_kvmAppSetting.skinOpacity = value;
              }
          }
      }
      ...
      Row {
          ...
          SkinBaseButton {
              ...
              onClicked: {
                    ...
                    g_kvmAppSetting.skinOpacity = 0.9
              }
          }
      }
  }
  ...
  enter: Transition {
        ...
        ScriptAction {
            script: _content.positionViewAtIndex( g_kvmAppSetting.skinIndex, GridView.Center);
        }
  }
  exit: Transition {
        id: _exitAnima
