...
Item {
    ...
    property var itemsArrays: [
        {
            name: qsTr("trKVMResPageTitle"),
            icon: "",
            stretch: false
        },
        {
            name: qsTr("trKVMScreenlayoutPageTitle"),
            icon: "",
            stretch: false
        },
        {
            name: qsTr("trKVMSchemePageTitle"),
            icon: "",
            stretch: false
        },
        {
            name: qsTr("trKVMGrabPageTitle"),
            icon: "",
            stretch: false
        },
        {
            name: qsTr("trKVMPushPageTitle"),
            icon: "",
            stretch: false
        },
        {
