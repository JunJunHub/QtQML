...
Item {
    ...
    property int tailHeight: _sideBar.height*0.25
    property int tailSlopeHeight: _sideBar.height*0.008
    ...
    property int tailWidth:  layoutPreferredWidth ? layoutPreferredWidth*0.083 : _sideBar.width*0.083
    ...
    Rectangle {
        ...
        color: bckColor
        visible: horizontalPosBase === Sidebar.PosToLeft ? (_sideBar.x  == -content.width ? false : true ) :
                                        (_sideBar.x  == parent.width-tailWidth ? false : true)
